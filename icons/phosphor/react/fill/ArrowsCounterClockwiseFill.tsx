...
/**
 * ArrowsCounterClockwiseFill icon component
 * Generated from Phosphor Icons
 */
export const ArrowsCounterClockwiseFill = React.forwardRef<
  SVGSVGElement,
...
ArrowsCounterClockwiseFill.displayName = 'ArrowsCounterClockwiseFill';
