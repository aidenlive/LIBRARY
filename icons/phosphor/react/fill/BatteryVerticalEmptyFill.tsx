...
/**
 * BatteryVerticalEmptyFill icon component
 * Generated from Phosphor Icons
 */
export const BatteryVerticalEmptyFill = React.forwardRef<
  SVGSVGElement,
...
BatteryVerticalEmptyFill.displayName = 'BatteryVerticalEmptyFill';
