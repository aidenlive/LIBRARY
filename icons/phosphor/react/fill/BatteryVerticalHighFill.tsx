...
/**
 * BatteryVerticalHighFill icon component
 * Generated from Phosphor Icons
 */
export const BatteryVerticalHighFill = React.forwardRef<
  SVGSVGElement,
...
BatteryVerticalHighFill.displayName = 'BatteryVerticalHighFill';
