...
/**
 * FileMagnifyingGlassFill icon component
 * Generated from Phosphor Icons
 */
export const FileMagnifyingGlassFill = React.forwardRef<
  SVGSVGElement,
...
FileMagnifyingGlassFill.displayName = 'FileMagnifyingGlassFill';
