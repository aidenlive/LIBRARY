...
/**
 * ListMagnifyingGlassFill icon component
 * Generated from Phosphor Icons
 */
export const ListMagnifyingGlassFill = React.forwardRef<
  SVGSVGElement,
...
ListMagnifyingGlassFill.displayName = 'ListMagnifyingGlassFill';
