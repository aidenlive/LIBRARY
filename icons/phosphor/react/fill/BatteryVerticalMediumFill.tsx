...
/**
 * BatteryVerticalMediumFill icon component
 * Generated from Phosphor Icons
 */
export const BatteryVerticalMediumFill = React.forwardRef<
  SVGSVGElement,
...
BatteryVerticalMediumFill.displayName = 'BatteryVerticalMediumFill';
