...
/**
 * CaretCircleDoubleRightFill icon component
 * Generated from Phosphor Icons
 */
export const CaretCircleDoubleRightFill = React.forwardRef<
  SVGSVGElement,
...
CaretCircleDoubleRightFill.displayName = 'CaretCircleDoubleRightFill';
