...
/**
 * GoogleCardboardLogoFill icon component
 * Generated from Phosphor Icons
 */
export const GoogleCardboardLogoFill = React.forwardRef<
  SVGSVGElement,
...
GoogleCardboardLogoFill.displayName = 'GoogleCardboardLogoFill';
