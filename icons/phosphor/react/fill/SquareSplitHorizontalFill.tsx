...
/**
 * SquareSplitHorizontalFill icon component
 * Generated from Phosphor Icons
 */
export const SquareSplitHorizontalFill = React.forwardRef<
  SVGSVGElement,
...
SquareSplitHorizontalFill.displayName = 'SquareSplitHorizontalFill';
