...
/**
 * BatteryVerticalFullFill icon component
 * Generated from Phosphor Icons
 */
export const BatteryVerticalFullFill = React.forwardRef<
  SVGSVGElement,
...
BatteryVerticalFullFill.displayName = 'BatteryVerticalFullFill';
