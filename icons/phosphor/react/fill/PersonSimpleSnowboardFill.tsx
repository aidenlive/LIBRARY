...
/**
 * PersonSimpleSnowboardFill icon component
 * Generated from Phosphor Icons
 */
export const PersonSimpleSnowboardFill = React.forwardRef<
  SVGSVGElement,
...
PersonSimpleSnowboardFill.displayName = 'PersonSimpleSnowboardFill';
