...
/**
 * CaretCircleDoubleLeftFill icon component
 * Generated from Phosphor Icons
 */
export const CaretCircleDoubleLeftFill = React.forwardRef<
  SVGSVGElement,
...
CaretCircleDoubleLeftFill.displayName = 'CaretCircleDoubleLeftFill';
