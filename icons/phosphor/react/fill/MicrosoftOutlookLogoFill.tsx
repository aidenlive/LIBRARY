...
/**
 * MicrosoftOutlookLogoFill icon component
 * Generated from Phosphor Icons
 */
export const MicrosoftOutlookLogoFill = React.forwardRef<
  SVGSVGElement,
...
MicrosoftOutlookLogoFill.displayName = 'MicrosoftOutlookLogoFill';
