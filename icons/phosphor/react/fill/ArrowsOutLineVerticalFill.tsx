...
/**
 * ArrowsOutLineVerticalFill icon component
 * Generated from Phosphor Icons
 */
export const ArrowsOutLineVerticalFill = React.forwardRef<
  SVGSVGElement,
...
ArrowsOutLineVerticalFill.displayName = 'ArrowsOutLineVerticalFill';
