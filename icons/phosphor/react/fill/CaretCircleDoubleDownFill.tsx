...
/**
 * CaretCircleDoubleDownFill icon component
 * Generated from Phosphor Icons
 */
export const CaretCircleDoubleDownFill = React.forwardRef<
  SVGSVGElement,
...
CaretCircleDoubleDownFill.displayName = 'CaretCircleDoubleDownFill';
