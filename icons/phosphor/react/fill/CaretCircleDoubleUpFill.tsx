...
/**
 * CaretCircleDoubleUpFill icon component
 * Generated from Phosphor Icons
 */
export const CaretCircleDoubleUpFill = React.forwardRef<
  SVGSVGElement,
...
CaretCircleDoubleUpFill.displayName = 'CaretCircleDoubleUpFill';
