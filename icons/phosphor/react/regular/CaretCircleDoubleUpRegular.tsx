...
/**
 * CaretCircleDoubleUpRegular icon component
 * Generated from Phosphor Icons
 */
export const CaretCircleDoubleUpRegular = React.forwardRef<
  SVGSVGElement,
...
CaretCircleDoubleUpRegular.displayName = 'CaretCircleDoubleUpRegular';
