...
/**
 * ArrowElbowDownLeftRegular icon component
 * Generated from Phosphor Icons
 */
export const ArrowElbowDownLeftRegular = React.forwardRef<
  SVGSVGElement,
...
ArrowElbowDownLeftRegular.displayName = 'ArrowElbowDownLeftRegular';
