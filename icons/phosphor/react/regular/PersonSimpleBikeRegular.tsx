...
/**
 * PersonSimpleBikeRegular icon component
 * Generated from Phosphor Icons
 */
export const PersonSimpleBikeRegular = React.forwardRef<
  SVGSVGElement,
...
PersonSimpleBikeRegular.displayName = 'PersonSimpleBikeRegular';
