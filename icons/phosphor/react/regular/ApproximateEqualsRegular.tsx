...
/**
 * ApproximateEqualsRegular icon component
 * Generated from Phosphor Icons
 */
export const ApproximateEqualsRegular = React.forwardRef<
  SVGSVGElement,
...
ApproximateEqualsRegular.displayName = 'ApproximateEqualsRegular';
