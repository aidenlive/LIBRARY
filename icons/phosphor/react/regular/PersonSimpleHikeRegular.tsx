...
/**
 * PersonSimpleHikeRegular icon component
 * Generated from Phosphor Icons
 */
export const PersonSimpleHikeRegular = React.forwardRef<
  SVGSVGElement,
...
PersonSimpleHikeRegular.displayName = 'PersonSimpleHikeRegular';
