...
/**
 * FolderSimpleDashedRegular icon component
 * Generated from Phosphor Icons
 */
export const FolderSimpleDashedRegular = React.forwardRef<
  SVGSVGElement,
...
FolderSimpleDashedRegular.displayName = 'FolderSimpleDashedRegular';
