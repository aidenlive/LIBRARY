...
/**
 * BatteryVerticalEmptyRegular icon component
 * Generated from Phosphor Icons
 */
export const BatteryVerticalEmptyRegular = React.forwardRef<
  SVGSVGElement,
...
BatteryVerticalEmptyRegular.displayName = 'BatteryVerticalEmptyRegular';
