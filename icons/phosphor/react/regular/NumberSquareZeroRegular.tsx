...
/**
 * NumberSquareZeroRegular icon component
 * Generated from Phosphor Icons
 */
export const NumberSquareZeroRegular = React.forwardRef<
  SVGSVGElement,
...
NumberSquareZeroRegular.displayName = 'NumberSquareZeroRegular';
