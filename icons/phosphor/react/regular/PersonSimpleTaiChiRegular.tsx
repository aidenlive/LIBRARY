...
/**
 * PersonSimpleTaiChiRegular icon component
 * Generated from Phosphor Icons
 */
export const PersonSimpleTaiChiRegular = React.forwardRef<
  SVGSVGElement,
...
PersonSimpleTaiChiRegular.displayName = 'PersonSimpleTaiChiRegular';
