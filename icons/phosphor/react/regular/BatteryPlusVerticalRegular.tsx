...
/**
 * BatteryPlusVerticalRegular icon component
 * Generated from Phosphor Icons
 */
export const BatteryPlusVerticalRegular = React.forwardRef<
  SVGSVGElement,
...
BatteryPlusVerticalRegular.displayName = 'BatteryPlusVerticalRegular';
