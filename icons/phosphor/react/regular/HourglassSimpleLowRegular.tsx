...
/**
 * HourglassSimpleLowRegular icon component
 * Generated from Phosphor Icons
 */
export const HourglassSimpleLowRegular = React.forwardRef<
  SVGSVGElement,
...
HourglassSimpleLowRegular.displayName = 'HourglassSimpleLowRegular';
