...
/**
 * MapPinSimpleAreaRegular icon component
 * Generated from Phosphor Icons
 */
export const MapPinSimpleAreaRegular = React.forwardRef<
  SVGSVGElement,
...
MapPinSimpleAreaRegular.displayName = 'MapPinSimpleAreaRegular';
