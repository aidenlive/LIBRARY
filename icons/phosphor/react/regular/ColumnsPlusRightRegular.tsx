...
/**
 * ColumnsPlusRightRegular icon component
 * Generated from Phosphor Icons
 */
export const ColumnsPlusRightRegular = React.forwardRef<
  SVGSVGElement,
...
ColumnsPlusRightRegular.displayName = 'ColumnsPlusRightRegular';
