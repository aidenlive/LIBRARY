...
/**
 * ContactlessPaymentRegular icon component
 * Generated from Phosphor Icons
 */
export const ContactlessPaymentRegular = React.forwardRef<
  SVGSVGElement,
...
ContactlessPaymentRegular.displayName = 'ContactlessPaymentRegular';
