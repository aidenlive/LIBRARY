...
/**
 * CaretCircleUpDownRegular icon component
 * Generated from Phosphor Icons
 */
export const CaretCircleUpDownRegular = React.forwardRef<
  SVGSVGElement,
...
CaretCircleUpDownRegular.displayName = 'CaretCircleUpDownRegular';
