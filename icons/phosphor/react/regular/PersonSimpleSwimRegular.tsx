...
/**
 * PersonSimpleSwimRegular icon component
 * Generated from Phosphor Icons
 */
export const PersonSimpleSwimRegular = React.forwardRef<
  SVGSVGElement,
...
PersonSimpleSwimRegular.displayName = 'PersonSimpleSwimRegular';
