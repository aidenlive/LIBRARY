...
/**
 * CaretCircleDoubleDownRegular icon component
 * Generated from Phosphor Icons
 */
export const CaretCircleDoubleDownRegular = React.forwardRef<
  SVGSVGElement,
...
CaretCircleDoubleDownRegular.displayName = 'CaretCircleDoubleDownRegular';
