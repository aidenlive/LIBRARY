...
/**
 * PersonSimpleSnowboardRegular icon component
 * Generated from Phosphor Icons
 */
export const PersonSimpleSnowboardRegular = React.forwardRef<
  SVGSVGElement,
...
PersonSimpleSnowboardRegular.displayName = 'PersonSimpleSnowboardRegular';
