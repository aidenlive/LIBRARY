...
/**
 * ChatTeardropSlashRegular icon component
 * Generated from Phosphor Icons
 */
export const ChatTeardropSlashRegular = React.forwardRef<
  SVGSVGElement,
...
ChatTeardropSlashRegular.displayName = 'ChatTeardropSlashRegular';
