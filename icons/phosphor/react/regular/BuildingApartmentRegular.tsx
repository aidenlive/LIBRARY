...
/**
 * BuildingApartmentRegular icon component
 * Generated from Phosphor Icons
 */
export const BuildingApartmentRegular = React.forwardRef<
  SVGSVGElement,
...
BuildingApartmentRegular.displayName = 'BuildingApartmentRegular';
