...
/**
 * PencilSimpleSlashRegular icon component
 * Generated from Phosphor Icons
 */
export const PencilSimpleSlashRegular = React.forwardRef<
  SVGSVGElement,
...
PencilSimpleSlashRegular.displayName = 'PencilSimpleSlashRegular';
