...
/**
 * CaretDoubleRightRegular icon component
 * Generated from Phosphor Icons
 */
export const CaretDoubleRightRegular = React.forwardRef<
  SVGSVGElement,
...
CaretDoubleRightRegular.displayName = 'CaretDoubleRightRegular';
