...
/**
 * PencilSimpleLineRegular icon component
 * Generated from Phosphor Icons
 */
export const PencilSimpleLineRegular = React.forwardRef<
  SVGSVGElement,
...
PencilSimpleLineRegular.displayName = 'PencilSimpleLineRegular';
