...
/**
 * ChatCenteredSlashRegular icon component
 * Generated from Phosphor Icons
 */
export const ChatCenteredSlashRegular = React.forwardRef<
  SVGSVGElement,
...
ChatCenteredSlashRegular.displayName = 'ChatCenteredSlashRegular';
