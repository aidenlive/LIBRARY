...
/**
 * WheelchairMotionRegular icon component
 * Generated from Phosphor Icons
 */
export const WheelchairMotionRegular = React.forwardRef<
  SVGSVGElement,
...
WheelchairMotionRegular.displayName = 'WheelchairMotionRegular';
