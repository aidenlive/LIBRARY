...
/**
 * ListMagnifyingGlassRegular icon component
 * Generated from Phosphor Icons
 */
export const ListMagnifyingGlassRegular = React.forwardRef<
  SVGSVGElement,
...
ListMagnifyingGlassRegular.displayName = 'ListMagnifyingGlassRegular';
