...
/**
 * AirTrafficControlRegular icon component
 * Generated from Phosphor Icons
 */
export const AirTrafficControlRegular = React.forwardRef<
  SVGSVGElement,
...
AirTrafficControlRegular.displayName = 'AirTrafficControlRegular';
