...
/**
 * GoogleCardboardLogoRegular icon component
 * Generated from Phosphor Icons
 */
export const GoogleCardboardLogoRegular = React.forwardRef<
  SVGSVGElement,
...
GoogleCardboardLogoRegular.displayName = 'GoogleCardboardLogoRegular';
