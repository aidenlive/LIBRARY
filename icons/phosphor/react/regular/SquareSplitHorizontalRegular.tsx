...
/**
 * SquareSplitHorizontalRegular icon component
 * Generated from Phosphor Icons
 */
export const SquareSplitHorizontalRegular = React.forwardRef<
  SVGSVGElement,
...
SquareSplitHorizontalRegular.displayName = 'SquareSplitHorizontalRegular';
