...
/**
 * DeviceMobileSlashRegular icon component
 * Generated from Phosphor Icons
 */
export const DeviceMobileSlashRegular = React.forwardRef<
  SVGSVGElement,
...
DeviceMobileSlashRegular.displayName = 'DeviceMobileSlashRegular';
