...
/**
 * MicrosoftOutlookLogoRegular icon component
 * Generated from Phosphor Icons
 */
export const MicrosoftOutlookLogoRegular = React.forwardRef<
  SVGSVGElement,
...
MicrosoftOutlookLogoRegular.displayName = 'MicrosoftOutlookLogoRegular';
