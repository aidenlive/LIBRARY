...
/**
 * ArrowBendRightDownRegular icon component
 * Generated from Phosphor Icons
 */
export const ArrowBendRightDownRegular = React.forwardRef<
  SVGSVGElement,
...
ArrowBendRightDownRegular.displayName = 'ArrowBendRightDownRegular';
