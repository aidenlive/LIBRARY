...
/**
 * StandardDefinitionRegular icon component
 * Generated from Phosphor Icons
 */
export const StandardDefinitionRegular = React.forwardRef<
  SVGSVGElement,
...
StandardDefinitionRegular.displayName = 'StandardDefinitionRegular';
