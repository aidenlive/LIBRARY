...
/**
 * PersonArmsSpreadRegular icon component
 * Generated from Phosphor Icons
 */
export const PersonArmsSpreadRegular = React.forwardRef<
  SVGSVGElement,
...
PersonArmsSpreadRegular.displayName = 'PersonArmsSpreadRegular';
