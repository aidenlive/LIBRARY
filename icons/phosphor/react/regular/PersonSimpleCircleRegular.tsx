...
/**
 * PersonSimpleCircleRegular icon component
 * Generated from Phosphor Icons
 */
export const PersonSimpleCircleRegular = React.forwardRef<
  SVGSVGElement,
...
PersonSimpleCircleRegular.displayName = 'PersonSimpleCircleRegular';
