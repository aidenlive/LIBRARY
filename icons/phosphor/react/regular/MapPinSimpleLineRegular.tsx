...
/**
 * MapPinSimpleLineRegular icon component
 * Generated from Phosphor Icons
 */
export const MapPinSimpleLineRegular = React.forwardRef<
  SVGSVGElement,
...
MapPinSimpleLineRegular.displayName = 'MapPinSimpleLineRegular';
