...
/**
 * BatteryVerticalLowRegular icon component
 * Generated from Phosphor Icons
 */
export const BatteryVerticalLowRegular = React.forwardRef<
  SVGSVGElement,
...
BatteryVerticalLowRegular.displayName = 'BatteryVerticalLowRegular';
