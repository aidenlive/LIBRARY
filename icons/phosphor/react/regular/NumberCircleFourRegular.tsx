...
/**
 * NumberCircleFourRegular icon component
 * Generated from Phosphor Icons
 */
export const NumberCircleFourRegular = React.forwardRef<
  SVGSVGElement,
...
NumberCircleFourRegular.displayName = 'NumberCircleFourRegular';
