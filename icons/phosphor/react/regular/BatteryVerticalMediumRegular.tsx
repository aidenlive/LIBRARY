...
/**
 * BatteryVerticalMediumRegular icon component
 * Generated from Phosphor Icons
 */
export const BatteryVerticalMediumRegular = React.forwardRef<
  SVGSVGElement,
...
BatteryVerticalMediumRegular.displayName = 'BatteryVerticalMediumRegular';
