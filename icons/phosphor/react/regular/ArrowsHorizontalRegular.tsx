...
/**
 * ArrowsHorizontalRegular icon component
 * Generated from Phosphor Icons
 */
export const ArrowsHorizontalRegular = React.forwardRef<
  SVGSVGElement,
...
ArrowsHorizontalRegular.displayName = 'ArrowsHorizontalRegular';
