...
/**
 * PersonSimpleThrowRegular icon component
 * Generated from Phosphor Icons
 */
export const PersonSimpleThrowRegular = React.forwardRef<
  SVGSVGElement,
...
PersonSimpleThrowRegular.displayName = 'PersonSimpleThrowRegular';
