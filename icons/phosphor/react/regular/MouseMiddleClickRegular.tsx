...
/**
 * MouseMiddleClickRegular icon component
 * Generated from Phosphor Icons
 */
export const MouseMiddleClickRegular = React.forwardRef<
  SVGSVGElement,
...
MouseMiddleClickRegular.displayName = 'MouseMiddleClickRegular';
