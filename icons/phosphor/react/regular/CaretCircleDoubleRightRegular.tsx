...
/**
 * CaretCircleDoubleRightRegular icon component
 * Generated from Phosphor Icons
 */
export const CaretCircleDoubleRightRegular = React.forwardRef<
  SVGSVGElement,
...
CaretCircleDoubleRightRegular.displayName = 'CaretCircleDoubleRightRegular';
