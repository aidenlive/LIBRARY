...
/**
 * ArrowElbowDownLeftLight icon component
 * Generated from Phosphor Icons
 */
export const ArrowElbowDownLeftLight = React.forwardRef<
  SVGSVGElement,
...
ArrowElbowDownLeftLight.displayName = 'ArrowElbowDownLeftLight';
