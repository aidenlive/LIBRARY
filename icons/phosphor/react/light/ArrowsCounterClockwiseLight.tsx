...
/**
 * ArrowsCounterClockwiseLight icon component
 * Generated from Phosphor Icons
 */
export const ArrowsCounterClockwiseLight = React.forwardRef<
  SVGSVGElement,
...
ArrowsCounterClockwiseLight.displayName = 'ArrowsCounterClockwiseLight';
