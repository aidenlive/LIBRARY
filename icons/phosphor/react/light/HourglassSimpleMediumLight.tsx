...
/**
 * HourglassSimpleMediumLight icon component
 * Generated from Phosphor Icons
 */
export const HourglassSimpleMediumLight = React.forwardRef<
  SVGSVGElement,
...
HourglassSimpleMediumLight.displayName = 'HourglassSimpleMediumLight';
