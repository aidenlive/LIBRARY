...
/**
 * ArrowFatLinesRightLight icon component
 * Generated from Phosphor Icons
 */
export const ArrowFatLinesRightLight = React.forwardRef<
  SVGSVGElement,
...
ArrowFatLinesRightLight.displayName = 'ArrowFatLinesRightLight';
