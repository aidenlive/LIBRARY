...
/**
 * DotsThreeCircleVerticalLight icon component
 * Generated from Phosphor Icons
 */
export const DotsThreeCircleVerticalLight = React.forwardRef<
  SVGSVGElement,
...
DotsThreeCircleVerticalLight.displayName = 'DotsThreeCircleVerticalLight';
