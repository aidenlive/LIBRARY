...
/**
 * ContactlessPaymentLight icon component
 * Generated from Phosphor Icons
 */
export const ContactlessPaymentLight = React.forwardRef<
  SVGSVGElement,
...
ContactlessPaymentLight.displayName = 'ContactlessPaymentLight';
