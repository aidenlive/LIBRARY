...
/**
 * ArrowSquareDownLeftLight icon component
 * Generated from Phosphor Icons
 */
export const ArrowSquareDownLeftLight = React.forwardRef<
  SVGSVGElement,
...
ArrowSquareDownLeftLight.displayName = 'ArrowSquareDownLeftLight';
