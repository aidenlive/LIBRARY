...
/**
 * SquareSplitHorizontalLight icon component
 * Generated from Phosphor Icons
 */
export const SquareSplitHorizontalLight = React.forwardRef<
  SVGSVGElement,
...
SquareSplitHorizontalLight.displayName = 'SquareSplitHorizontalLight';
