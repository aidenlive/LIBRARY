...
/**
 * MicrosoftTeamsLogoLight icon component
 * Generated from Phosphor Icons
 */
export const MicrosoftTeamsLogoLight = React.forwardRef<
  SVGSVGElement,
...
MicrosoftTeamsLogoLight.displayName = 'MicrosoftTeamsLogoLight';
