...
/**
 * AlignCenterHorizontalLight icon component
 * Generated from Phosphor Icons
 */
export const AlignCenterHorizontalLight = React.forwardRef<
  SVGSVGElement,
...
AlignCenterHorizontalLight.displayName = 'AlignCenterHorizontalLight';
