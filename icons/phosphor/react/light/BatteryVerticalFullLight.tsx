...
/**
 * BatteryVerticalFullLight icon component
 * Generated from Phosphor Icons
 */
export const BatteryVerticalFullLight = React.forwardRef<
  SVGSVGElement,
...
BatteryVerticalFullLight.displayName = 'BatteryVerticalFullLight';
