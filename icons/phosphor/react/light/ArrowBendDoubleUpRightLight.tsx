...
/**
 * ArrowBendDoubleUpRightLight icon component
 * Generated from Phosphor Icons
 */
export const ArrowBendDoubleUpRightLight = React.forwardRef<
  SVGSVGElement,
...
ArrowBendDoubleUpRightLight.displayName = 'ArrowBendDoubleUpRightLight';
