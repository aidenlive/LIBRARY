...
/**
 * EnvelopeSimpleOpenLight icon component
 * Generated from Phosphor Icons
 */
export const EnvelopeSimpleOpenLight = React.forwardRef<
  SVGSVGElement,
...
EnvelopeSimpleOpenLight.displayName = 'EnvelopeSimpleOpenLight';
