...
/**
 * DotsThreeOutlineVerticalLight icon component
 * Generated from Phosphor Icons
 */
export const DotsThreeOutlineVerticalLight = React.forwardRef<
  SVGSVGElement,
...
DotsThreeOutlineVerticalLight.displayName = 'DotsThreeOutlineVerticalLight';
