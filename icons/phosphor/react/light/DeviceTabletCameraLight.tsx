...
/**
 * DeviceTabletCameraLight icon component
 * Generated from Phosphor Icons
 */
export const DeviceTabletCameraLight = React.forwardRef<
  SVGSVGElement,
...
DeviceTabletCameraLight.displayName = 'DeviceTabletCameraLight';
