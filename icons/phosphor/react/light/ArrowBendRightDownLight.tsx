...
/**
 * ArrowBendRightDownLight icon component
 * Generated from Phosphor Icons
 */
export const ArrowBendRightDownLight = React.forwardRef<
  SVGSVGElement,
...
ArrowBendRightDownLight.displayName = 'ArrowBendRightDownLight';
