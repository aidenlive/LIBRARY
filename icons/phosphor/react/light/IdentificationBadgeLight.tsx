...
/**
 * IdentificationBadgeLight icon component
 * Generated from Phosphor Icons
 */
export const IdentificationBadgeLight = React.forwardRef<
  SVGSVGElement,
...
IdentificationBadgeLight.displayName = 'IdentificationBadgeLight';
