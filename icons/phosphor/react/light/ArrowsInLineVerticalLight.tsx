...
/**
 * ArrowsInLineVerticalLight icon component
 * Generated from Phosphor Icons
 */
export const ArrowsInLineVerticalLight = React.forwardRef<
  SVGSVGElement,
...
ArrowsInLineVerticalLight.displayName = 'ArrowsInLineVerticalLight';
