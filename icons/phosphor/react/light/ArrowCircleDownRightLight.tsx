...
/**
 * ArrowCircleDownRightLight icon component
 * Generated from Phosphor Icons
 */
export const ArrowCircleDownRightLight = React.forwardRef<
  SVGSVGElement,
...
ArrowCircleDownRightLight.displayName = 'ArrowCircleDownRightLight';
