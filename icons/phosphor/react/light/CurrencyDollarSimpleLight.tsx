...
/**
 * CurrencyDollarSimpleLight icon component
 * Generated from Phosphor Icons
 */
export const CurrencyDollarSimpleLight = React.forwardRef<
  SVGSVGElement,
...
CurrencyDollarSimpleLight.displayName = 'CurrencyDollarSimpleLight';
