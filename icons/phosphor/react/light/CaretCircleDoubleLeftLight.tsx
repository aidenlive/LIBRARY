...
/**
 * CaretCircleDoubleLeftLight icon component
 * Generated from Phosphor Icons
 */
export const CaretCircleDoubleLeftLight = React.forwardRef<
  SVGSVGElement,
...
CaretCircleDoubleLeftLight.displayName = 'CaretCircleDoubleLeftLight';
