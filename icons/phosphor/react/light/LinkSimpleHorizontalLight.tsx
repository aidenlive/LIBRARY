...
/**
 * LinkSimpleHorizontalLight icon component
 * Generated from Phosphor Icons
 */
export const LinkSimpleHorizontalLight = React.forwardRef<
  SVGSVGElement,
...
LinkSimpleHorizontalLight.displayName = 'LinkSimpleHorizontalLight';
