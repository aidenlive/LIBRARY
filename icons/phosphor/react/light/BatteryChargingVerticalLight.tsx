...
/**
 * BatteryChargingVerticalLight icon component
 * Generated from Phosphor Icons
 */
export const BatteryChargingVerticalLight = React.forwardRef<
  SVGSVGElement,
...
BatteryChargingVerticalLight.displayName = 'BatteryChargingVerticalLight';
