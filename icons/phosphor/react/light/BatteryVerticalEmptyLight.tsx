...
/**
 * BatteryVerticalEmptyLight icon component
 * Generated from Phosphor Icons
 */
export const BatteryVerticalEmptyLight = React.forwardRef<
  SVGSVGElement,
...
BatteryVerticalEmptyLight.displayName = 'BatteryVerticalEmptyLight';
