...
/**
 * ProjectorScreenChartLight icon component
 * Generated from Phosphor Icons
 */
export const ProjectorScreenChartLight = React.forwardRef<
  SVGSVGElement,
...
ProjectorScreenChartLight.displayName = 'ProjectorScreenChartLight';
