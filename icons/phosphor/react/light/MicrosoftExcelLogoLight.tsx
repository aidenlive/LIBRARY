...
/**
 * MicrosoftExcelLogoLight icon component
 * Generated from Phosphor Icons
 */
export const MicrosoftExcelLogoLight = React.forwardRef<
  SVGSVGElement,
...
MicrosoftExcelLogoLight.displayName = 'MicrosoftExcelLogoLight';
