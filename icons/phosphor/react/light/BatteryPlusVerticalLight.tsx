...
/**
 * BatteryPlusVerticalLight icon component
 * Generated from Phosphor Icons
 */
export const BatteryPlusVerticalLight = React.forwardRef<
  SVGSVGElement,
...
BatteryPlusVerticalLight.displayName = 'BatteryPlusVerticalLight';
