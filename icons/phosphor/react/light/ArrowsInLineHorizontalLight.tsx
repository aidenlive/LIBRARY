...
/**
 * ArrowsInLineHorizontalLight icon component
 * Generated from Phosphor Icons
 */
export const ArrowsInLineHorizontalLight = React.forwardRef<
  SVGSVGElement,
...
ArrowsInLineHorizontalLight.displayName = 'ArrowsInLineHorizontalLight';
