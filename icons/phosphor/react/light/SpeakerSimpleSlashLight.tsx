...
/**
 * SpeakerSimpleSlashLight icon component
 * Generated from Phosphor Icons
 */
export const SpeakerSimpleSlashLight = React.forwardRef<
  SVGSVGElement,
...
SpeakerSimpleSlashLight.displayName = 'SpeakerSimpleSlashLight';
