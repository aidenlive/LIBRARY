...
/**
 * MicrosoftOutlookLogoLight icon component
 * Generated from Phosphor Icons
 */
export const MicrosoftOutlookLogoLight = React.forwardRef<
  SVGSVGElement,
...
MicrosoftOutlookLogoLight.displayName = 'MicrosoftOutlookLogoLight';
