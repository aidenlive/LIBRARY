...
/**
 * SelectionBackgroundLight icon component
 * Generated from Phosphor Icons
 */
export const SelectionBackgroundLight = React.forwardRef<
  SVGSVGElement,
...
SelectionBackgroundLight.displayName = 'SelectionBackgroundLight';
