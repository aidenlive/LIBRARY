...
/**
 * CurrencyCircleDollarLight icon component
 * Generated from Phosphor Icons
 */
export const CurrencyCircleDollarLight = React.forwardRef<
  SVGSVGElement,
...
CurrencyCircleDollarLight.displayName = 'CurrencyCircleDollarLight';
