...
/**
 * ClockCounterClockwiseLight icon component
 * Generated from Phosphor Icons
 */
export const ClockCounterClockwiseLight = React.forwardRef<
  SVGSVGElement,
...
ClockCounterClockwiseLight.displayName = 'ClockCounterClockwiseLight';
