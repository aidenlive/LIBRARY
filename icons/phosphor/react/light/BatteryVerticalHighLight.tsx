...
/**
 * BatteryVerticalHighLight icon component
 * Generated from Phosphor Icons
 */
export const BatteryVerticalHighLight = React.forwardRef<
  SVGSVGElement,
...
BatteryVerticalHighLight.displayName = 'BatteryVerticalHighLight';
