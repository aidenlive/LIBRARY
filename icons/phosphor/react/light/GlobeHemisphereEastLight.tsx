...
/**
 * GlobeHemisphereEastLight icon component
 * Generated from Phosphor Icons
 */
export const GlobeHemisphereEastLight = React.forwardRef<
  SVGSVGElement,
...
GlobeHemisphereEastLight.displayName = 'GlobeHemisphereEastLight';
