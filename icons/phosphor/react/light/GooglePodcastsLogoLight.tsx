...
/**
 * GooglePodcastsLogoLight icon component
 * Generated from Phosphor Icons
 */
export const GooglePodcastsLogoLight = React.forwardRef<
  SVGSVGElement,
...
GooglePodcastsLogoLight.displayName = 'GooglePodcastsLogoLight';
