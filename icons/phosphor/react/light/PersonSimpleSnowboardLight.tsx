...
/**
 * PersonSimpleSnowboardLight icon component
 * Generated from Phosphor Icons
 */
export const PersonSimpleSnowboardLight = React.forwardRef<
  SVGSVGElement,
...
PersonSimpleSnowboardLight.displayName = 'PersonSimpleSnowboardLight';
