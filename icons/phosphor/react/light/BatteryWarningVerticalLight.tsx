...
/**
 * BatteryWarningVerticalLight icon component
 * Generated from Phosphor Icons
 */
export const BatteryWarningVerticalLight = React.forwardRef<
  SVGSVGElement,
...
BatteryWarningVerticalLight.displayName = 'BatteryWarningVerticalLight';
