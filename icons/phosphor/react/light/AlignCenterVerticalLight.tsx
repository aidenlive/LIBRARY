...
/**
 * AlignCenterVerticalLight icon component
 * Generated from Phosphor Icons
 */
export const AlignCenterVerticalLight = React.forwardRef<
  SVGSVGElement,
...
AlignCenterVerticalLight.displayName = 'AlignCenterVerticalLight';
