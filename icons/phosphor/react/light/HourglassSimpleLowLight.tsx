...
/**
 * HourglassSimpleLowLight icon component
 * Generated from Phosphor Icons
 */
export const HourglassSimpleLowLight = React.forwardRef<
  SVGSVGElement,
...
HourglassSimpleLowLight.displayName = 'HourglassSimpleLowLight';
