...
/**
 * ArrowCounterClockwiseLight icon component
 * Generated from Phosphor Icons
 */
export const ArrowCounterClockwiseLight = React.forwardRef<
  SVGSVGElement,
...
ArrowCounterClockwiseLight.displayName = 'ArrowCounterClockwiseLight';
