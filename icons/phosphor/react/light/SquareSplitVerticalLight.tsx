...
/**
 * SquareSplitVerticalLight icon component
 * Generated from Phosphor Icons
 */
export const SquareSplitVerticalLight = React.forwardRef<
  SVGSVGElement,
...
SquareSplitVerticalLight.displayName = 'SquareSplitVerticalLight';
