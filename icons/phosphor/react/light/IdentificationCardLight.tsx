...
/**
 * IdentificationCardLight icon component
 * Generated from Phosphor Icons
 */
export const IdentificationCardLight = React.forwardRef<
  SVGSVGElement,
...
IdentificationCardLight.displayName = 'IdentificationCardLight';
