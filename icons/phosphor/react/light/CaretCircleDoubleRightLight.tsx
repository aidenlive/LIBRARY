...
/**
 * CaretCircleDoubleRightLight icon component
 * Generated from Phosphor Icons
 */
export const CaretCircleDoubleRightLight = React.forwardRef<
  SVGSVGElement,
...
CaretCircleDoubleRightLight.displayName = 'CaretCircleDoubleRightLight';
