...
/**
 * SelectionForegroundLight icon component
 * Generated from Phosphor Icons
 */
export const SelectionForegroundLight = React.forwardRef<
  SVGSVGElement,
...
SelectionForegroundLight.displayName = 'SelectionForegroundLight';
