...
/**
 * FolderSimpleDashedLight icon component
 * Generated from Phosphor Icons
 */
export const FolderSimpleDashedLight = React.forwardRef<
  SVGSVGElement,
...
FolderSimpleDashedLight.displayName = 'FolderSimpleDashedLight';
