...
/**
 * PushPinSimpleSlashLight icon component
 * Generated from Phosphor Icons
 */
export const PushPinSimpleSlashLight = React.forwardRef<
  SVGSVGElement,
...
PushPinSimpleSlashLight.displayName = 'PushPinSimpleSlashLight';
