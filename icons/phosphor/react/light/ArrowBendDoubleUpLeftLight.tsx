...
/**
 * ArrowBendDoubleUpLeftLight icon component
 * Generated from Phosphor Icons
 */
export const ArrowBendDoubleUpLeftLight = React.forwardRef<
  SVGSVGElement,
...
ArrowBendDoubleUpLeftLight.displayName = 'ArrowBendDoubleUpLeftLight';
