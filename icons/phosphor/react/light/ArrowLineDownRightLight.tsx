...
/**
 * ArrowLineDownRightLight icon component
 * Generated from Phosphor Icons
 */
export const ArrowLineDownRightLight = React.forwardRef<
  SVGSVGElement,
...
ArrowLineDownRightLight.displayName = 'ArrowLineDownRightLight';
