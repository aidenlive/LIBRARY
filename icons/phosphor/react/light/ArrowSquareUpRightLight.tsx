...
/**
 * ArrowSquareUpRightLight icon component
 * Generated from Phosphor Icons
 */
export const ArrowSquareUpRightLight = React.forwardRef<
  SVGSVGElement,
...
ArrowSquareUpRightLight.displayName = 'ArrowSquareUpRightLight';
