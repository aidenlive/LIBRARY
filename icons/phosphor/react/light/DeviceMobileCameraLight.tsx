...
/**
 * DeviceMobileCameraLight icon component
 * Generated from Phosphor Icons
 */
export const DeviceMobileCameraLight = React.forwardRef<
  SVGSVGElement,
...
DeviceMobileCameraLight.displayName = 'DeviceMobileCameraLight';
