...
/**
 * BatteryVerticalLowLight icon component
 * Generated from Phosphor Icons
 */
export const BatteryVerticalLowLight = React.forwardRef<
  SVGSVGElement,
...
BatteryVerticalLowLight.displayName = 'BatteryVerticalLowLight';
