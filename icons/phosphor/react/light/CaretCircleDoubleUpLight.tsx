...
/**
 * CaretCircleDoubleUpLight icon component
 * Generated from Phosphor Icons
 */
export const CaretCircleDoubleUpLight = React.forwardRef<
  SVGSVGElement,
...
CaretCircleDoubleUpLight.displayName = 'CaretCircleDoubleUpLight';
