...
/**
 * GoogleCardboardLogoLight icon component
 * Generated from Phosphor Icons
 */
export const GoogleCardboardLogoLight = React.forwardRef<
  SVGSVGElement,
...
GoogleCardboardLogoLight.displayName = 'GoogleCardboardLogoLight';
