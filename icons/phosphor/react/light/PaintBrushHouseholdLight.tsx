...
/**
 * PaintBrushHouseholdLight icon component
 * Generated from Phosphor Icons
 */
export const PaintBrushHouseholdLight = React.forwardRef<
  SVGSVGElement,
...
PaintBrushHouseholdLight.displayName = 'PaintBrushHouseholdLight';
