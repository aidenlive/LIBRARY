...
/**
 * ListMagnifyingGlassLight icon component
 * Generated from Phosphor Icons
 */
export const ListMagnifyingGlassLight = React.forwardRef<
  SVGSVGElement,
...
ListMagnifyingGlassLight.displayName = 'ListMagnifyingGlassLight';
