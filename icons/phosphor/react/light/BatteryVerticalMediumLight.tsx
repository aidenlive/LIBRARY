...
/**
 * BatteryVerticalMediumLight icon component
 * Generated from Phosphor Icons
 */
export const BatteryVerticalMediumLight = React.forwardRef<
  SVGSVGElement,
...
BatteryVerticalMediumLight.displayName = 'BatteryVerticalMediumLight';
