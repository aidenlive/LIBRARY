...
/**
 * GreaterThanOrEqualLight icon component
 * Generated from Phosphor Icons
 */
export const GreaterThanOrEqualLight = React.forwardRef<
  SVGSVGElement,
...
GreaterThanOrEqualLight.displayName = 'GreaterThanOrEqualLight';
