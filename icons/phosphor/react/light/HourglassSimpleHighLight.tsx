...
/**
 * HourglassSimpleHighLight icon component
 * Generated from Phosphor Icons
 */
export const HourglassSimpleHighLight = React.forwardRef<
  SVGSVGElement,
...
HourglassSimpleHighLight.displayName = 'HourglassSimpleHighLight';
