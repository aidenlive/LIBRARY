...
/**
 * ArrowsOutLineHorizontalLight icon component
 * Generated from Phosphor Icons
 */
export const ArrowsOutLineHorizontalLight = React.forwardRef<
  SVGSVGElement,
...
ArrowsOutLineHorizontalLight.displayName = 'ArrowsOutLineHorizontalLight';
