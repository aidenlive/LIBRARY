...
/**
 * PersonSimpleCircleLight icon component
 * Generated from Phosphor Icons
 */
export const PersonSimpleCircleLight = React.forwardRef<
  SVGSVGElement,
...
PersonSimpleCircleLight.displayName = 'PersonSimpleCircleLight';
