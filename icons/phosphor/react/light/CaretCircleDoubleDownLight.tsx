...
/**
 * CaretCircleDoubleDownLight icon component
 * Generated from Phosphor Icons
 */
export const CaretCircleDoubleDownLight = React.forwardRef<
  SVGSVGElement,
...
CaretCircleDoubleDownLight.displayName = 'CaretCircleDoubleDownLight';
