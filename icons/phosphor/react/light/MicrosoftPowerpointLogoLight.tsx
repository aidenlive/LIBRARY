...
/**
 * MicrosoftPowerpointLogoLight icon component
 * Generated from Phosphor Icons
 */
export const MicrosoftPowerpointLogoLight = React.forwardRef<
  SVGSVGElement,
...
MicrosoftPowerpointLogoLight.displayName = 'MicrosoftPowerpointLogoLight';
