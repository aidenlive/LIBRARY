...
/**
 * ArrowsOutLineVerticalLight icon component
 * Generated from Phosphor Icons
 */
export const ArrowsOutLineVerticalLight = React.forwardRef<
  SVGSVGElement,
...
ArrowsOutLineVerticalLight.displayName = 'ArrowsOutLineVerticalLight';
