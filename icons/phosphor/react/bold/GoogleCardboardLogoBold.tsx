...
/**
 * GoogleCardboardLogoBold icon component
 * Generated from Phosphor Icons
 */
export const GoogleCardboardLogoBold = React.forwardRef<
  SVGSVGElement,
...
GoogleCardboardLogoBold.displayName = 'GoogleCardboardLogoBold';
