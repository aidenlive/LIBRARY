...
/**
 * IdentificationBadgeBold icon component
 * Generated from Phosphor Icons
 */
export const IdentificationBadgeBold = React.forwardRef<
  SVGSVGElement,
...
IdentificationBadgeBold.displayName = 'IdentificationBadgeBold';
