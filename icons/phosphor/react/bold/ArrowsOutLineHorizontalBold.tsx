...
/**
 * ArrowsOutLineHorizontalBold icon component
 * Generated from Phosphor Icons
 */
export const ArrowsOutLineHorizontalBold = React.forwardRef<
  SVGSVGElement,
...
ArrowsOutLineHorizontalBold.displayName = 'ArrowsOutLineHorizontalBold';
