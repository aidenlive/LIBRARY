...
/**
 * BatteryVerticalMediumBold icon component
 * Generated from Phosphor Icons
 */
export const BatteryVerticalMediumBold = React.forwardRef<
  SVGSVGElement,
...
BatteryVerticalMediumBold.displayName = 'BatteryVerticalMediumBold';
