...
/**
 * ArrowBendDoubleUpLeftBold icon component
 * Generated from Phosphor Icons
 */
export const ArrowBendDoubleUpLeftBold = React.forwardRef<
  SVGSVGElement,
...
ArrowBendDoubleUpLeftBold.displayName = 'ArrowBendDoubleUpLeftBold';
