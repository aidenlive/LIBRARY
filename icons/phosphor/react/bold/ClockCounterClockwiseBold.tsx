...
/**
 * ClockCounterClockwiseBold icon component
 * Generated from Phosphor Icons
 */
export const ClockCounterClockwiseBold = React.forwardRef<
  SVGSVGElement,
...
ClockCounterClockwiseBold.displayName = 'ClockCounterClockwiseBold';
