...
/**
 * HourglassSimpleHighBold icon component
 * Generated from Phosphor Icons
 */
export const HourglassSimpleHighBold = React.forwardRef<
  SVGSVGElement,
...
HourglassSimpleHighBold.displayName = 'HourglassSimpleHighBold';
