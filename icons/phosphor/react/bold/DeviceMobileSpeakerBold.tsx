...
/**
 * DeviceMobileSpeakerBold icon component
 * Generated from Phosphor Icons
 */
export const DeviceMobileSpeakerBold = React.forwardRef<
  SVGSVGElement,
...
DeviceMobileSpeakerBold.displayName = 'DeviceMobileSpeakerBold';
