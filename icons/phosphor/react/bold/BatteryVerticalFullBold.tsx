...
/**
 * BatteryVerticalFullBold icon component
 * Generated from Phosphor Icons
 */
export const BatteryVerticalFullBold = React.forwardRef<
  SVGSVGElement,
...
BatteryVerticalFullBold.displayName = 'BatteryVerticalFullBold';
