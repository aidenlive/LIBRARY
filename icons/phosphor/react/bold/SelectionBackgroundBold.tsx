...
/**
 * SelectionBackgroundBold icon component
 * Generated from Phosphor Icons
 */
export const SelectionBackgroundBold = React.forwardRef<
  SVGSVGElement,
...
SelectionBackgroundBold.displayName = 'SelectionBackgroundBold';
