...
/**
 * SquareSplitHorizontalBold icon component
 * Generated from Phosphor Icons
 */
export const SquareSplitHorizontalBold = React.forwardRef<
  SVGSVGElement,
...
SquareSplitHorizontalBold.displayName = 'SquareSplitHorizontalBold';
