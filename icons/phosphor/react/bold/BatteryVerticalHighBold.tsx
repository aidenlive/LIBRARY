...
/**
 * BatteryVerticalHighBold icon component
 * Generated from Phosphor Icons
 */
export const BatteryVerticalHighBold = React.forwardRef<
  SVGSVGElement,
...
BatteryVerticalHighBold.displayName = 'BatteryVerticalHighBold';
