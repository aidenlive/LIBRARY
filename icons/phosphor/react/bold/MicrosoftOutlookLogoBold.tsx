...
/**
 * MicrosoftOutlookLogoBold icon component
 * Generated from Phosphor Icons
 */
export const MicrosoftOutlookLogoBold = React.forwardRef<
  SVGSVGElement,
...
MicrosoftOutlookLogoBold.displayName = 'MicrosoftOutlookLogoBold';
