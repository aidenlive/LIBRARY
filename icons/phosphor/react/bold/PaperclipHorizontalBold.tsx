...
/**
 * PaperclipHorizontalBold icon component
 * Generated from Phosphor Icons
 */
export const PaperclipHorizontalBold = React.forwardRef<
  SVGSVGElement,
...
PaperclipHorizontalBold.displayName = 'PaperclipHorizontalBold';
