...
/**
 * MicrosoftPowerpointLogoBold icon component
 * Generated from Phosphor Icons
 */
export const MicrosoftPowerpointLogoBold = React.forwardRef<
  SVGSVGElement,
...
MicrosoftPowerpointLogoBold.displayName = 'MicrosoftPowerpointLogoBold';
