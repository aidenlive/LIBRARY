...
/**
 * GlobeHemisphereEastBold icon component
 * Generated from Phosphor Icons
 */
export const GlobeHemisphereEastBold = React.forwardRef<
  SVGSVGElement,
...
GlobeHemisphereEastBold.displayName = 'GlobeHemisphereEastBold';
