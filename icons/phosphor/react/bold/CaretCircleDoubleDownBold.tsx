...
/**
 * CaretCircleDoubleDownBold icon component
 * Generated from Phosphor Icons
 */
export const CaretCircleDoubleDownBold = React.forwardRef<
  SVGSVGElement,
...
CaretCircleDoubleDownBold.displayName = 'CaretCircleDoubleDownBold';
