...
/**
 * AlignCenterHorizontalBold icon component
 * Generated from Phosphor Icons
 */
export const AlignCenterHorizontalBold = React.forwardRef<
  SVGSVGElement,
...
AlignCenterHorizontalBold.displayName = 'AlignCenterHorizontalBold';
