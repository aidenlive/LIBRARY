...
/**
 * PersonSimpleSnowboardBold icon component
 * Generated from Phosphor Icons
 */
export const PersonSimpleSnowboardBold = React.forwardRef<
  SVGSVGElement,
...
PersonSimpleSnowboardBold.displayName = 'PersonSimpleSnowboardBold';
