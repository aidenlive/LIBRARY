...
/**
 * ArrowCounterClockwiseBold icon component
 * Generated from Phosphor Icons
 */
export const ArrowCounterClockwiseBold = React.forwardRef<
  SVGSVGElement,
...
ArrowCounterClockwiseBold.displayName = 'ArrowCounterClockwiseBold';
