...
/**
 * CaretCircleDoubleLeftBold icon component
 * Generated from Phosphor Icons
 */
export const CaretCircleDoubleLeftBold = React.forwardRef<
  SVGSVGElement,
...
CaretCircleDoubleLeftBold.displayName = 'CaretCircleDoubleLeftBold';
