...
/**
 * ProjectorScreenChartBold icon component
 * Generated from Phosphor Icons
 */
export const ProjectorScreenChartBold = React.forwardRef<
  SVGSVGElement,
...
ProjectorScreenChartBold.displayName = 'ProjectorScreenChartBold';
