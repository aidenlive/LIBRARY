...
/**
 * MagnifyingGlassMinusBold icon component
 * Generated from Phosphor Icons
 */
export const MagnifyingGlassMinusBold = React.forwardRef<
  SVGSVGElement,
...
MagnifyingGlassMinusBold.displayName = 'MagnifyingGlassMinusBold';
