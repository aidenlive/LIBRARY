...
/**
 * PaintBrushHouseholdBold icon component
 * Generated from Phosphor Icons
 */
export const PaintBrushHouseholdBold = React.forwardRef<
  SVGSVGElement,
...
PaintBrushHouseholdBold.displayName = 'PaintBrushHouseholdBold';
