...
/**
 * LinkSimpleHorizontalBold icon component
 * Generated from Phosphor Icons
 */
export const LinkSimpleHorizontalBold = React.forwardRef<
  SVGSVGElement,
...
LinkSimpleHorizontalBold.displayName = 'LinkSimpleHorizontalBold';
