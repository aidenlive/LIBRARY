...
/**
 * CurrencyDollarSimpleBold icon component
 * Generated from Phosphor Icons
 */
export const CurrencyDollarSimpleBold = React.forwardRef<
  SVGSVGElement,
...
CurrencyDollarSimpleBold.displayName = 'CurrencyDollarSimpleBold';
