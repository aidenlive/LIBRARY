...
/**
 * CaretCircleDoubleUpBold icon component
 * Generated from Phosphor Icons
 */
export const CaretCircleDoubleUpBold = React.forwardRef<
  SVGSVGElement,
...
CaretCircleDoubleUpBold.displayName = 'CaretCircleDoubleUpBold';
