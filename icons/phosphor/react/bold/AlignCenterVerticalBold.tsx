...
/**
 * AlignCenterVerticalBold icon component
 * Generated from Phosphor Icons
 */
export const AlignCenterVerticalBold = React.forwardRef<
  SVGSVGElement,
...
AlignCenterVerticalBold.displayName = 'AlignCenterVerticalBold';
