...
/**
 * ArrowsCounterClockwiseBold icon component
 * Generated from Phosphor Icons
 */
export const ArrowsCounterClockwiseBold = React.forwardRef<
  SVGSVGElement,
...
ArrowsCounterClockwiseBold.displayName = 'ArrowsCounterClockwiseBold';
