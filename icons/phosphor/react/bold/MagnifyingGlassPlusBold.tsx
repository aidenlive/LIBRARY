...
/**
 * MagnifyingGlassPlusBold icon component
 * Generated from Phosphor Icons
 */
export const MagnifyingGlassPlusBold = React.forwardRef<
  SVGSVGElement,
...
MagnifyingGlassPlusBold.displayName = 'MagnifyingGlassPlusBold';
