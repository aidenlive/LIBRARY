...
/**
 * DeviceTabletSpeakerBold icon component
 * Generated from Phosphor Icons
 */
export const DeviceTabletSpeakerBold = React.forwardRef<
  SVGSVGElement,
...
DeviceTabletSpeakerBold.displayName = 'DeviceTabletSpeakerBold';
