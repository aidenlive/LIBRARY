...
/**
 * SelectionForegroundBold icon component
 * Generated from Phosphor Icons
 */
export const SelectionForegroundBold = React.forwardRef<
  SVGSVGElement,
...
SelectionForegroundBold.displayName = 'SelectionForegroundBold';
