...
/**
 * DotsThreeOutlineVerticalBold icon component
 * Generated from Phosphor Icons
 */
export const DotsThreeOutlineVerticalBold = React.forwardRef<
  SVGSVGElement,
...
DotsThreeOutlineVerticalBold.displayName = 'DotsThreeOutlineVerticalBold';
