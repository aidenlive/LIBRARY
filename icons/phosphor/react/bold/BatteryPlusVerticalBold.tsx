...
/**
 * BatteryPlusVerticalBold icon component
 * Generated from Phosphor Icons
 */
export const BatteryPlusVerticalBold = React.forwardRef<
  SVGSVGElement,
...
BatteryPlusVerticalBold.displayName = 'BatteryPlusVerticalBold';
