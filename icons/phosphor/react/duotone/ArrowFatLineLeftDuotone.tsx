...
/**
 * ArrowFatLineLeftDuotone icon component
 * Generated from Phosphor Icons
 */
export const ArrowFatLineLeftDuotone = React.forwardRef<
  SVGSVGElement,
...
ArrowFatLineLeftDuotone.displayName = 'ArrowFatLineLeftDuotone';
