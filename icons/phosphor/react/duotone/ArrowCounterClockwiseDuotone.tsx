...
/**
 * ArrowCounterClockwiseDuotone icon component
 * Generated from Phosphor Icons
 */
export const ArrowCounterClockwiseDuotone = React.forwardRef<
  SVGSVGElement,
...
ArrowCounterClockwiseDuotone.displayName = 'ArrowCounterClockwiseDuotone';
