...
/**
 * ThermometerSimpleDuotone icon component
 * Generated from Phosphor Icons
 */
export const ThermometerSimpleDuotone = React.forwardRef<
  SVGSVGElement,
...
ThermometerSimpleDuotone.displayName = 'ThermometerSimpleDuotone';
