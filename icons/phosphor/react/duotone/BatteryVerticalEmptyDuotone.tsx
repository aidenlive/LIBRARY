...
/**
 * BatteryVerticalEmptyDuotone icon component
 * Generated from Phosphor Icons
 */
export const BatteryVerticalEmptyDuotone = React.forwardRef<
  SVGSVGElement,
...
BatteryVerticalEmptyDuotone.displayName = 'BatteryVerticalEmptyDuotone';
