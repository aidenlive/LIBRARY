...
/**
 * ChatCenteredDotsDuotone icon component
 * Generated from Phosphor Icons
 */
export const ChatCenteredDotsDuotone = React.forwardRef<
  SVGSVGElement,
...
ChatCenteredDotsDuotone.displayName = 'ChatCenteredDotsDuotone';
