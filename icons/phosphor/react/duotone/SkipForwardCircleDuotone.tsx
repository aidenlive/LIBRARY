...
/**
 * SkipForwardCircleDuotone icon component
 * Generated from Phosphor Icons
 */
export const SkipForwardCircleDuotone = React.forwardRef<
  SVGSVGElement,
...
SkipForwardCircleDuotone.displayName = 'SkipForwardCircleDuotone';
