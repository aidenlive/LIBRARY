...
/**
 * ArrowsOutLineVerticalDuotone icon component
 * Generated from Phosphor Icons
 */
export const ArrowsOutLineVerticalDuotone = React.forwardRef<
  SVGSVGElement,
...
ArrowsOutLineVerticalDuotone.displayName = 'ArrowsOutLineVerticalDuotone';
