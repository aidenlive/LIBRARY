...
/**
 * AirTrafficControlDuotone icon component
 * Generated from Phosphor Icons
 */
export const AirTrafficControlDuotone = React.forwardRef<
  SVGSVGElement,
...
AirTrafficControlDuotone.displayName = 'AirTrafficControlDuotone';
