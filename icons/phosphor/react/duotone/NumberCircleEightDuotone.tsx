...
/**
 * NumberCircleEightDuotone icon component
 * Generated from Phosphor Icons
 */
export const NumberCircleEightDuotone = React.forwardRef<
  SVGSVGElement,
...
NumberCircleEightDuotone.displayName = 'NumberCircleEightDuotone';
