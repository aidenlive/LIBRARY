...
/**
 * FolderSimpleUserDuotone icon component
 * Generated from Phosphor Icons
 */
export const FolderSimpleUserDuotone = React.forwardRef<
  SVGSVGElement,
...
FolderSimpleUserDuotone.displayName = 'FolderSimpleUserDuotone';
