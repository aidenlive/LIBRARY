...
/**
 * ArrowElbowLeftUpDuotone icon component
 * Generated from Phosphor Icons
 */
export const ArrowElbowLeftUpDuotone = React.forwardRef<
  SVGSVGElement,
...
ArrowElbowLeftUpDuotone.displayName = 'ArrowElbowLeftUpDuotone';
