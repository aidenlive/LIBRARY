...
/**
 * MicrosoftTeamsLogoDuotone icon component
 * Generated from Phosphor Icons
 */
export const MicrosoftTeamsLogoDuotone = React.forwardRef<
  SVGSVGElement,
...
MicrosoftTeamsLogoDuotone.displayName = 'MicrosoftTeamsLogoDuotone';
