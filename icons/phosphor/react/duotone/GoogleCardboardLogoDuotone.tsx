...
/**
 * GoogleCardboardLogoDuotone icon component
 * Generated from Phosphor Icons
 */
export const GoogleCardboardLogoDuotone = React.forwardRef<
  SVGSVGElement,
...
GoogleCardboardLogoDuotone.displayName = 'GoogleCardboardLogoDuotone';
