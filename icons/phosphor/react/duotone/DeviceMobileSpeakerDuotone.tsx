...
/**
 * DeviceMobileSpeakerDuotone icon component
 * Generated from Phosphor Icons
 */
export const DeviceMobileSpeakerDuotone = React.forwardRef<
  SVGSVGElement,
...
DeviceMobileSpeakerDuotone.displayName = 'DeviceMobileSpeakerDuotone';
