...
/**
 * EyedropperSampleDuotone icon component
 * Generated from Phosphor Icons
 */
export const EyedropperSampleDuotone = React.forwardRef<
  SVGSVGElement,
...
EyedropperSampleDuotone.displayName = 'EyedropperSampleDuotone';
