...
/**
 * DeviceTabletCameraDuotone icon component
 * Generated from Phosphor Icons
 */
export const DeviceTabletCameraDuotone = React.forwardRef<
  SVGSVGElement,
...
DeviceTabletCameraDuotone.displayName = 'DeviceTabletCameraDuotone';
