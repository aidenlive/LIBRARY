...
/**
 * PersonSimpleSnowboardDuotone icon component
 * Generated from Phosphor Icons
 */
export const PersonSimpleSnowboardDuotone = React.forwardRef<
  SVGSVGElement,
...
PersonSimpleSnowboardDuotone.displayName = 'PersonSimpleSnowboardDuotone';
