...
/**
 * BatteryVerticalFullDuotone icon component
 * Generated from Phosphor Icons
 */
export const BatteryVerticalFullDuotone = React.forwardRef<
  SVGSVGElement,
...
BatteryVerticalFullDuotone.displayName = 'BatteryVerticalFullDuotone';
