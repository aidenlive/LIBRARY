...
/**
 * HeartStraightBreakDuotone icon component
 * Generated from Phosphor Icons
 */
export const HeartStraightBreakDuotone = React.forwardRef<
  SVGSVGElement,
...
HeartStraightBreakDuotone.displayName = 'HeartStraightBreakDuotone';
