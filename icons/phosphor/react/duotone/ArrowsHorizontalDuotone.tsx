...
/**
 * ArrowsHorizontalDuotone icon component
 * Generated from Phosphor Icons
 */
export const ArrowsHorizontalDuotone = React.forwardRef<
  SVGSVGElement,
...
ArrowsHorizontalDuotone.displayName = 'ArrowsHorizontalDuotone';
