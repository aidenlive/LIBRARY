...
/**
 * TelevisionSimpleDuotone icon component
 * Generated from Phosphor Icons
 */
export const TelevisionSimpleDuotone = React.forwardRef<
  SVGSVGElement,
...
TelevisionSimpleDuotone.displayName = 'TelevisionSimpleDuotone';
