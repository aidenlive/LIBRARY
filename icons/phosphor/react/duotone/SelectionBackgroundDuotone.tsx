...
/**
 * SelectionBackgroundDuotone icon component
 * Generated from Phosphor Icons
 */
export const SelectionBackgroundDuotone = React.forwardRef<
  SVGSVGElement,
...
SelectionBackgroundDuotone.displayName = 'SelectionBackgroundDuotone';
