...
/**
 * BluetoothConnectedDuotone icon component
 * Generated from Phosphor Icons
 */
export const BluetoothConnectedDuotone = React.forwardRef<
  SVGSVGElement,
...
BluetoothConnectedDuotone.displayName = 'BluetoothConnectedDuotone';
