...
/**
 * ArrowElbowRightDownDuotone icon component
 * Generated from Phosphor Icons
 */
export const ArrowElbowRightDownDuotone = React.forwardRef<
  SVGSVGElement,
...
ArrowElbowRightDownDuotone.displayName = 'ArrowElbowRightDownDuotone';
