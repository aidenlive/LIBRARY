...
/**
 * MouseMiddleClickDuotone icon component
 * Generated from Phosphor Icons
 */
export const MouseMiddleClickDuotone = React.forwardRef<
  SVGSVGElement,
...
MouseMiddleClickDuotone.displayName = 'MouseMiddleClickDuotone';
