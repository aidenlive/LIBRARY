...
/**
 * ArrowLineDownLeftDuotone icon component
 * Generated from Phosphor Icons
 */
export const ArrowLineDownLeftDuotone = React.forwardRef<
  SVGSVGElement,
...
ArrowLineDownLeftDuotone.displayName = 'ArrowLineDownLeftDuotone';
