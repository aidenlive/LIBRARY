...
/**
 * BatteryVerticalHighDuotone icon component
 * Generated from Phosphor Icons
 */
export const BatteryVerticalHighDuotone = React.forwardRef<
  SVGSVGElement,
...
BatteryVerticalHighDuotone.displayName = 'BatteryVerticalHighDuotone';
