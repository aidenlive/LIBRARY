...
/**
 * ListMagnifyingGlassDuotone icon component
 * Generated from Phosphor Icons
 */
export const ListMagnifyingGlassDuotone = React.forwardRef<
  SVGSVGElement,
...
ListMagnifyingGlassDuotone.displayName = 'ListMagnifyingGlassDuotone';
