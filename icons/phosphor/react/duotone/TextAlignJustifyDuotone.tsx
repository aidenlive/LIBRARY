...
/**
 * TextAlignJustifyDuotone icon component
 * Generated from Phosphor Icons
 */
export const TextAlignJustifyDuotone = React.forwardRef<
  SVGSVGElement,
...
TextAlignJustifyDuotone.displayName = 'TextAlignJustifyDuotone';
