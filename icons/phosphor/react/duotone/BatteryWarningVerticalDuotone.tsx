...
/**
 * BatteryWarningVerticalDuotone icon component
 * Generated from Phosphor Icons
 */
export const BatteryWarningVerticalDuotone = React.forwardRef<
  SVGSVGElement,
...
BatteryWarningVerticalDuotone.displayName = 'BatteryWarningVerticalDuotone';
