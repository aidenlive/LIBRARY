...
/**
 * NumberCircleZeroDuotone icon component
 * Generated from Phosphor Icons
 */
export const NumberCircleZeroDuotone = React.forwardRef<
  SVGSVGElement,
...
NumberCircleZeroDuotone.displayName = 'NumberCircleZeroDuotone';
