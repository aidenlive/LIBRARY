...
/**
 * GenderTransgenderDuotone icon component
 * Generated from Phosphor Icons
 */
export const GenderTransgenderDuotone = React.forwardRef<
  SVGSVGElement,
...
GenderTransgenderDuotone.displayName = 'GenderTransgenderDuotone';
