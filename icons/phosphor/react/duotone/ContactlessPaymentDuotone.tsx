...
/**
 * ContactlessPaymentDuotone icon component
 * Generated from Phosphor Icons
 */
export const ContactlessPaymentDuotone = React.forwardRef<
  SVGSVGElement,
...
ContactlessPaymentDuotone.displayName = 'ContactlessPaymentDuotone';
