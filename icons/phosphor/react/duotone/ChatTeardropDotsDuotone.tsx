...
/**
 * ChatTeardropDotsDuotone icon component
 * Generated from Phosphor Icons
 */
export const ChatTeardropDotsDuotone = React.forwardRef<
  SVGSVGElement,
...
ChatTeardropDotsDuotone.displayName = 'ChatTeardropDotsDuotone';
