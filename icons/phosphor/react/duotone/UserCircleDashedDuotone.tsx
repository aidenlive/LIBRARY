...
/**
 * UserCircleDashedDuotone icon component
 * Generated from Phosphor Icons
 */
export const UserCircleDashedDuotone = React.forwardRef<
  SVGSVGElement,
...
UserCircleDashedDuotone.displayName = 'UserCircleDashedDuotone';
