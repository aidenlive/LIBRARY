...
/**
 * ApplePodcastsLogoDuotone icon component
 * Generated from Phosphor Icons
 */
export const ApplePodcastsLogoDuotone = React.forwardRef<
  SVGSVGElement,
...
ApplePodcastsLogoDuotone.displayName = 'ApplePodcastsLogoDuotone';
