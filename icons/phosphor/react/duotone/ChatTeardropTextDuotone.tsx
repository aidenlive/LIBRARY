...
/**
 * ChatTeardropTextDuotone icon component
 * Generated from Phosphor Icons
 */
export const ChatTeardropTextDuotone = React.forwardRef<
  SVGSVGElement,
...
ChatTeardropTextDuotone.displayName = 'ChatTeardropTextDuotone';
