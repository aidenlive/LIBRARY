...
/**
 * GooglePhotosLogoDuotone icon component
 * Generated from Phosphor Icons
 */
export const GooglePhotosLogoDuotone = React.forwardRef<
  SVGSVGElement,
...
GooglePhotosLogoDuotone.displayName = 'GooglePhotosLogoDuotone';
