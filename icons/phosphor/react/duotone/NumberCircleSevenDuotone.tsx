...
/**
 * NumberCircleSevenDuotone icon component
 * Generated from Phosphor Icons
 */
export const NumberCircleSevenDuotone = React.forwardRef<
  SVGSVGElement,
...
NumberCircleSevenDuotone.displayName = 'NumberCircleSevenDuotone';
