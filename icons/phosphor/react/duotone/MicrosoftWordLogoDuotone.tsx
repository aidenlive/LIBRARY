...
/**
 * MicrosoftWordLogoDuotone icon component
 * Generated from Phosphor Icons
 */
export const MicrosoftWordLogoDuotone = React.forwardRef<
  SVGSVGElement,
...
MicrosoftWordLogoDuotone.displayName = 'MicrosoftWordLogoDuotone';
