...
/**
 * CaretCircleUpDownDuotone icon component
 * Generated from Phosphor Icons
 */
export const CaretCircleUpDownDuotone = React.forwardRef<
  SVGSVGElement,
...
CaretCircleUpDownDuotone.displayName = 'CaretCircleUpDownDuotone';
