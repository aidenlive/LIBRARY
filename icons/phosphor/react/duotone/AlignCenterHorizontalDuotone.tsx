...
/**
 * AlignCenterHorizontalDuotone icon component
 * Generated from Phosphor Icons
 */
export const AlignCenterHorizontalDuotone = React.forwardRef<
  SVGSVGElement,
...
AlignCenterHorizontalDuotone.displayName = 'AlignCenterHorizontalDuotone';
