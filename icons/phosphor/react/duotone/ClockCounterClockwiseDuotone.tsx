...
/**
 * ClockCounterClockwiseDuotone icon component
 * Generated from Phosphor Icons
 */
export const ClockCounterClockwiseDuotone = React.forwardRef<
  SVGSVGElement,
...
ClockCounterClockwiseDuotone.displayName = 'ClockCounterClockwiseDuotone';
