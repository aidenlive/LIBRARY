...
/**
 * AlignCenterVerticalDuotone icon component
 * Generated from Phosphor Icons
 */
export const AlignCenterVerticalDuotone = React.forwardRef<
  SVGSVGElement,
...
AlignCenterVerticalDuotone.displayName = 'AlignCenterVerticalDuotone';
