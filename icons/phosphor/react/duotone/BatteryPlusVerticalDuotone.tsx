...
/**
 * BatteryPlusVerticalDuotone icon component
 * Generated from Phosphor Icons
 */
export const BatteryPlusVerticalDuotone = React.forwardRef<
  SVGSVGElement,
...
BatteryPlusVerticalDuotone.displayName = 'BatteryPlusVerticalDuotone';
