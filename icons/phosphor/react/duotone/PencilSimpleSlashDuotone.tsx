...
/**
 * PencilSimpleSlashDuotone icon component
 * Generated from Phosphor Icons
 */
export const PencilSimpleSlashDuotone = React.forwardRef<
  SVGSVGElement,
...
PencilSimpleSlashDuotone.displayName = 'PencilSimpleSlashDuotone';
