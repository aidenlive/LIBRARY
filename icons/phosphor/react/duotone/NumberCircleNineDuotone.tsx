...
/**
 * NumberCircleNineDuotone icon component
 * Generated from Phosphor Icons
 */
export const NumberCircleNineDuotone = React.forwardRef<
  SVGSVGElement,
...
NumberCircleNineDuotone.displayName = 'NumberCircleNineDuotone';
