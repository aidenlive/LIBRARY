...
/**
 * ChalkboardTeacherDuotone icon component
 * Generated from Phosphor Icons
 */
export const ChalkboardTeacherDuotone = React.forwardRef<
  SVGSVGElement,
...
ChalkboardTeacherDuotone.displayName = 'ChalkboardTeacherDuotone';
