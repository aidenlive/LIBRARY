...
/**
 * NumberCircleFiveDuotone icon component
 * Generated from Phosphor Icons
 */
export const NumberCircleFiveDuotone = React.forwardRef<
  SVGSVGElement,
...
NumberCircleFiveDuotone.displayName = 'NumberCircleFiveDuotone';
