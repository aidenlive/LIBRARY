...
/**
 * FolderSimplePlusDuotone icon component
 * Generated from Phosphor Icons
 */
export const FolderSimplePlusDuotone = React.forwardRef<
  SVGSVGElement,
...
FolderSimplePlusDuotone.displayName = 'FolderSimplePlusDuotone';
