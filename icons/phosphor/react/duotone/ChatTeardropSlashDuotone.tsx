...
/**
 * ChatTeardropSlashDuotone icon component
 * Generated from Phosphor Icons
 */
export const ChatTeardropSlashDuotone = React.forwardRef<
  SVGSVGElement,
...
ChatTeardropSlashDuotone.displayName = 'ChatTeardropSlashDuotone';
