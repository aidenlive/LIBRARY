...
/**
 * FolderSimpleDashedDuotone icon component
 * Generated from Phosphor Icons
 */
export const FolderSimpleDashedDuotone = React.forwardRef<
  SVGSVGElement,
...
FolderSimpleDashedDuotone.displayName = 'FolderSimpleDashedDuotone';
