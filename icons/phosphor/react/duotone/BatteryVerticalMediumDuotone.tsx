...
/**
 * BatteryVerticalMediumDuotone icon component
 * Generated from Phosphor Icons
 */
export const BatteryVerticalMediumDuotone = React.forwardRef<
  SVGSVGElement,
...
BatteryVerticalMediumDuotone.displayName = 'BatteryVerticalMediumDuotone';
