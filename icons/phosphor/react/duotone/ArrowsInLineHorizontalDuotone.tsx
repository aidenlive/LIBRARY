...
/**
 * ArrowsInLineHorizontalDuotone icon component
 * Generated from Phosphor Icons
 */
export const ArrowsInLineHorizontalDuotone = React.forwardRef<
  SVGSVGElement,
...
ArrowsInLineHorizontalDuotone.displayName = 'ArrowsInLineHorizontalDuotone';
