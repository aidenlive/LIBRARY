...
/**
 * FolderSimpleLockDuotone icon component
 * Generated from Phosphor Icons
 */
export const FolderSimpleLockDuotone = React.forwardRef<
  SVGSVGElement,
...
FolderSimpleLockDuotone.displayName = 'FolderSimpleLockDuotone';
