...
/**
 * GreaterThanOrEqualDuotone icon component
 * Generated from Phosphor Icons
 */
export const GreaterThanOrEqualDuotone = React.forwardRef<
  SVGSVGElement,
...
GreaterThanOrEqualDuotone.displayName = 'GreaterThanOrEqualDuotone';
