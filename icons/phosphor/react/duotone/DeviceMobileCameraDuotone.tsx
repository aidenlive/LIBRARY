...
/**
 * DeviceMobileCameraDuotone icon component
 * Generated from Phosphor Icons
 */
export const DeviceMobileCameraDuotone = React.forwardRef<
  SVGSVGElement,
...
DeviceMobileCameraDuotone.displayName = 'DeviceMobileCameraDuotone';
