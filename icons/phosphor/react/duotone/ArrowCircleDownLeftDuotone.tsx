...
/**
 * ArrowCircleDownLeftDuotone icon component
 * Generated from Phosphor Icons
 */
export const ArrowCircleDownLeftDuotone = React.forwardRef<
  SVGSVGElement,
...
ArrowCircleDownLeftDuotone.displayName = 'ArrowCircleDownLeftDuotone';
