...
/**
 * LightbulbFilamentDuotone icon component
 * Generated from Phosphor Icons
 */
export const LightbulbFilamentDuotone = React.forwardRef<
  SVGSVGElement,
...
LightbulbFilamentDuotone.displayName = 'LightbulbFilamentDuotone';
