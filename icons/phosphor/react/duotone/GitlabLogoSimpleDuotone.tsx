...
/**
 * GitlabLogoSimpleDuotone icon component
 * Generated from Phosphor Icons
 */
export const GitlabLogoSimpleDuotone = React.forwardRef<
  SVGSVGElement,
...
GitlabLogoSimpleDuotone.displayName = 'GitlabLogoSimpleDuotone';
