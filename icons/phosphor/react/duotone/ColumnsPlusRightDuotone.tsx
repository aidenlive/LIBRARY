...
/**
 * ColumnsPlusRightDuotone icon component
 * Generated from Phosphor Icons
 */
export const ColumnsPlusRightDuotone = React.forwardRef<
  SVGSVGElement,
...
ColumnsPlusRightDuotone.displayName = 'ColumnsPlusRightDuotone';
