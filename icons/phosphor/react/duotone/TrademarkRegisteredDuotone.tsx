...
/**
 * TrademarkRegisteredDuotone icon component
 * Generated from Phosphor Icons
 */
export const TrademarkRegisteredDuotone = React.forwardRef<
  SVGSVGElement,
...
TrademarkRegisteredDuotone.displayName = 'TrademarkRegisteredDuotone';
