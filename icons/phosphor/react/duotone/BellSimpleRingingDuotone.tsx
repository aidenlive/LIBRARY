...
/**
 * BellSimpleRingingDuotone icon component
 * Generated from Phosphor Icons
 */
export const BellSimpleRingingDuotone = React.forwardRef<
  SVGSVGElement,
...
BellSimpleRingingDuotone.displayName = 'BellSimpleRingingDuotone';
