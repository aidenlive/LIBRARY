...
/**
 * ClosedCaptioningDuotone icon component
 * Generated from Phosphor Icons
 */
export const ClosedCaptioningDuotone = React.forwardRef<
  SVGSVGElement,
...
ClosedCaptioningDuotone.displayName = 'ClosedCaptioningDuotone';
