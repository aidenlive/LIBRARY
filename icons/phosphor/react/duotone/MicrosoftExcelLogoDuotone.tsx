...
/**
 * MicrosoftExcelLogoDuotone icon component
 * Generated from Phosphor Icons
 */
export const MicrosoftExcelLogoDuotone = React.forwardRef<
  SVGSVGElement,
...
MicrosoftExcelLogoDuotone.displayName = 'MicrosoftExcelLogoDuotone';
