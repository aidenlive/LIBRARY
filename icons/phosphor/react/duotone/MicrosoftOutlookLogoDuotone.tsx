...
/**
 * MicrosoftOutlookLogoDuotone icon component
 * Generated from Phosphor Icons
 */
export const MicrosoftOutlookLogoDuotone = React.forwardRef<
  SVGSVGElement,
...
MicrosoftOutlookLogoDuotone.displayName = 'MicrosoftOutlookLogoDuotone';
