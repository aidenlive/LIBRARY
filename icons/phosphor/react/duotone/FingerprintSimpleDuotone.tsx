...
/**
 * FingerprintSimpleDuotone icon component
 * Generated from Phosphor Icons
 */
export const FingerprintSimpleDuotone = React.forwardRef<
  SVGSVGElement,
...
FingerprintSimpleDuotone.displayName = 'FingerprintSimpleDuotone';
