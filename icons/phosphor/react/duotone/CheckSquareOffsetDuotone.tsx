...
/**
 * CheckSquareOffsetDuotone icon component
 * Generated from Phosphor Icons
 */
export const CheckSquareOffsetDuotone = React.forwardRef<
  SVGSVGElement,
...
CheckSquareOffsetDuotone.displayName = 'CheckSquareOffsetDuotone';
