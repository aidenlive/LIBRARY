...
/**
 * ArrowFatLinesLeftDuotone icon component
 * Generated from Phosphor Icons
 */
export const ArrowFatLinesLeftDuotone = React.forwardRef<
  SVGSVGElement,
...
ArrowFatLinesLeftDuotone.displayName = 'ArrowFatLinesLeftDuotone';
