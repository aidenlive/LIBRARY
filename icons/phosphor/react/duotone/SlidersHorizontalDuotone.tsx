...
/**
 * SlidersHorizontalDuotone icon component
 * Generated from Phosphor Icons
 */
export const SlidersHorizontalDuotone = React.forwardRef<
  SVGSVGElement,
...
SlidersHorizontalDuotone.displayName = 'SlidersHorizontalDuotone';
