...
/**
 * BuildingApartmentDuotone icon component
 * Generated from Phosphor Icons
 */
export const BuildingApartmentDuotone = React.forwardRef<
  SVGSVGElement,
...
BuildingApartmentDuotone.displayName = 'BuildingApartmentDuotone';
