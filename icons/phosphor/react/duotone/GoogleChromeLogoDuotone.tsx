...
/**
 * GoogleChromeLogoDuotone icon component
 * Generated from Phosphor Icons
 */
export const GoogleChromeLogoDuotone = React.forwardRef<
  SVGSVGElement,
...
GoogleChromeLogoDuotone.displayName = 'GoogleChromeLogoDuotone';
