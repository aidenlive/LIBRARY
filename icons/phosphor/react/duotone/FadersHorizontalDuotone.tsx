...
/**
 * FadersHorizontalDuotone icon component
 * Generated from Phosphor Icons
 */
export const FadersHorizontalDuotone = React.forwardRef<
  SVGSVGElement,
...
FadersHorizontalDuotone.displayName = 'FadersHorizontalDuotone';
