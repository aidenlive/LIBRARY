...
/**
 * MapPinSimpleLineDuotone icon component
 * Generated from Phosphor Icons
 */
export const MapPinSimpleLineDuotone = React.forwardRef<
  SVGSVGElement,
...
MapPinSimpleLineDuotone.displayName = 'MapPinSimpleLineDuotone';
