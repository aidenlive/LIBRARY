...
/**
 * DeviceTabletSpeakerDuotone icon component
 * Generated from Phosphor Icons
 */
export const DeviceTabletSpeakerDuotone = React.forwardRef<
  SVGSVGElement,
...
DeviceTabletSpeakerDuotone.displayName = 'DeviceTabletSpeakerDuotone';
