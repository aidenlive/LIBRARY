...
/**
 * CaretDoubleRightDuotone icon component
 * Generated from Phosphor Icons
 */
export const CaretDoubleRightDuotone = React.forwardRef<
  SVGSVGElement,
...
CaretDoubleRightDuotone.displayName = 'CaretDoubleRightDuotone';
