...
/**
 * PersonSimpleHikeDuotone icon component
 * Generated from Phosphor Icons
 */
export const PersonSimpleHikeDuotone = React.forwardRef<
  SVGSVGElement,
...
PersonSimpleHikeDuotone.displayName = 'PersonSimpleHikeDuotone';
