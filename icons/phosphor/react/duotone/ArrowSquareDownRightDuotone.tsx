...
/**
 * ArrowSquareDownRightDuotone icon component
 * Generated from Phosphor Icons
 */
export const ArrowSquareDownRightDuotone = React.forwardRef<
  SVGSVGElement,
...
ArrowSquareDownRightDuotone.displayName = 'ArrowSquareDownRightDuotone';
