...
/**
 * ArrowElbowLeftDownDuotone icon component
 * Generated from Phosphor Icons
 */
export const ArrowElbowLeftDownDuotone = React.forwardRef<
  SVGSVGElement,
...
ArrowElbowLeftDownDuotone.displayName = 'ArrowElbowLeftDownDuotone';
