...
/**
 * LinkSimpleHorizontalDuotone icon component
 * Generated from Phosphor Icons
 */
export const LinkSimpleHorizontalDuotone = React.forwardRef<
  SVGSVGElement,
...
LinkSimpleHorizontalDuotone.displayName = 'LinkSimpleHorizontalDuotone';
