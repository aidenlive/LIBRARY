...
/**
 * ArrowsInLineVerticalDuotone icon component
 * Generated from Phosphor Icons
 */
export const ArrowsInLineVerticalDuotone = React.forwardRef<
  SVGSVGElement,
...
ArrowsInLineVerticalDuotone.displayName = 'ArrowsInLineVerticalDuotone';
