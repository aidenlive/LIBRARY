...
/**
 * PersonSimpleCircleDuotone icon component
 * Generated from Phosphor Icons
 */
export const PersonSimpleCircleDuotone = React.forwardRef<
  SVGSVGElement,
...
PersonSimpleCircleDuotone.displayName = 'PersonSimpleCircleDuotone';
