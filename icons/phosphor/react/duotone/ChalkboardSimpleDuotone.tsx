...
/**
 * ChalkboardSimpleDuotone icon component
 * Generated from Phosphor Icons
 */
export const ChalkboardSimpleDuotone = React.forwardRef<
  SVGSVGElement,
...
ChalkboardSimpleDuotone.displayName = 'ChalkboardSimpleDuotone';
