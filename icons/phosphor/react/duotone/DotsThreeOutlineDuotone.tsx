...
/**
 * DotsThreeOutlineDuotone icon component
 * Generated from Phosphor Icons
 */
export const DotsThreeOutlineDuotone = React.forwardRef<
  SVGSVGElement,
...
DotsThreeOutlineDuotone.displayName = 'DotsThreeOutlineDuotone';
