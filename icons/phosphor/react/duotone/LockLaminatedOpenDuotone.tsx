...
/**
 * LockLaminatedOpenDuotone icon component
 * Generated from Phosphor Icons
 */
export const LockLaminatedOpenDuotone = React.forwardRef<
  SVGSVGElement,
...
LockLaminatedOpenDuotone.displayName = 'LockLaminatedOpenDuotone';
