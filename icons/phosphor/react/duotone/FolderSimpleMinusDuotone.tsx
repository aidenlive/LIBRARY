...
/**
 * FolderSimpleMinusDuotone icon component
 * Generated from Phosphor Icons
 */
export const FolderSimpleMinusDuotone = React.forwardRef<
  SVGSVGElement,
...
FolderSimpleMinusDuotone.displayName = 'FolderSimpleMinusDuotone';
