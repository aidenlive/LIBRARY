...
/**
 * ArrowFatLinesRightDuotone icon component
 * Generated from Phosphor Icons
 */
export const ArrowFatLinesRightDuotone = React.forwardRef<
  SVGSVGElement,
...
ArrowFatLinesRightDuotone.displayName = 'ArrowFatLinesRightDuotone';
