...
/**
 * BatteryVerticalEmptyThin icon component
 * Generated from Phosphor Icons
 */
export const BatteryVerticalEmptyThin = React.forwardRef<
  SVGSVGElement,
...
BatteryVerticalEmptyThin.displayName = 'BatteryVerticalEmptyThin';
