...
/**
 * SquareSplitVerticalThin icon component
 * Generated from Phosphor Icons
 */
export const SquareSplitVerticalThin = React.forwardRef<
  SVGSVGElement,
...
SquareSplitVerticalThin.displayName = 'SquareSplitVerticalThin';
