...
/**
 * GoogleCardboardLogoThin icon component
 * Generated from Phosphor Icons
 */
export const GoogleCardboardLogoThin = React.forwardRef<
  SVGSVGElement,
...
GoogleCardboardLogoThin.displayName = 'GoogleCardboardLogoThin';
