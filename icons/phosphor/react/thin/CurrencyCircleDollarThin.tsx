...
/**
 * CurrencyCircleDollarThin icon component
 * Generated from Phosphor Icons
 */
export const CurrencyCircleDollarThin = React.forwardRef<
  SVGSVGElement,
...
CurrencyCircleDollarThin.displayName = 'CurrencyCircleDollarThin';
