...
/**
 * HourglassSimpleHighThin icon component
 * Generated from Phosphor Icons
 */
export const HourglassSimpleHighThin = React.forwardRef<
  SVGSVGElement,
...
HourglassSimpleHighThin.displayName = 'HourglassSimpleHighThin';
