...
/**
 * ArrowElbowRightDownThin icon component
 * Generated from Phosphor Icons
 */
export const ArrowElbowRightDownThin = React.forwardRef<
  SVGSVGElement,
...
ArrowElbowRightDownThin.displayName = 'ArrowElbowRightDownThin';
