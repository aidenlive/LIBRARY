...
/**
 * HourglassSimpleMediumThin icon component
 * Generated from Phosphor Icons
 */
export const HourglassSimpleMediumThin = React.forwardRef<
  SVGSVGElement,
...
HourglassSimpleMediumThin.displayName = 'HourglassSimpleMediumThin';
