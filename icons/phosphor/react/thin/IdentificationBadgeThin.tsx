...
/**
 * IdentificationBadgeThin icon component
 * Generated from Phosphor Icons
 */
export const IdentificationBadgeThin = React.forwardRef<
  SVGSVGElement,
...
IdentificationBadgeThin.displayName = 'IdentificationBadgeThin';
