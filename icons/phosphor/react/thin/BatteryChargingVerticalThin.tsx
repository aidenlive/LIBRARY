...
/**
 * BatteryChargingVerticalThin icon component
 * Generated from Phosphor Icons
 */
export const BatteryChargingVerticalThin = React.forwardRef<
  SVGSVGElement,
...
BatteryChargingVerticalThin.displayName = 'BatteryChargingVerticalThin';
