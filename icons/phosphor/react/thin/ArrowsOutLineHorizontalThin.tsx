...
/**
 * ArrowsOutLineHorizontalThin icon component
 * Generated from Phosphor Icons
 */
export const ArrowsOutLineHorizontalThin = React.forwardRef<
  SVGSVGElement,
...
ArrowsOutLineHorizontalThin.displayName = 'ArrowsOutLineHorizontalThin';
