...
/**
 * GlobeHemisphereEastThin icon component
 * Generated from Phosphor Icons
 */
export const GlobeHemisphereEastThin = React.forwardRef<
  SVGSVGElement,
...
GlobeHemisphereEastThin.displayName = 'GlobeHemisphereEastThin';
