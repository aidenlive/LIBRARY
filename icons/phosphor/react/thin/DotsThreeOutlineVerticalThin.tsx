...
/**
 * DotsThreeOutlineVerticalThin icon component
 * Generated from Phosphor Icons
 */
export const DotsThreeOutlineVerticalThin = React.forwardRef<
  SVGSVGElement,
...
DotsThreeOutlineVerticalThin.displayName = 'DotsThreeOutlineVerticalThin';
