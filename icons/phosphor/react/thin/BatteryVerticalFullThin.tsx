...
/**
 * BatteryVerticalFullThin icon component
 * Generated from Phosphor Icons
 */
export const BatteryVerticalFullThin = React.forwardRef<
  SVGSVGElement,
...
BatteryVerticalFullThin.displayName = 'BatteryVerticalFullThin';
