...
/**
 * AlignCenterVerticalSimpleThin icon component
 * Generated from Phosphor Icons
 */
export const AlignCenterVerticalSimpleThin = React.forwardRef<
  SVGSVGElement,
...
AlignCenterVerticalSimpleThin.displayName = 'AlignCenterVerticalSimpleThin';
