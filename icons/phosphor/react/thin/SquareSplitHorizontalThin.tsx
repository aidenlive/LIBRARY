...
/**
 * SquareSplitHorizontalThin icon component
 * Generated from Phosphor Icons
 */
export const SquareSplitHorizontalThin = React.forwardRef<
  SVGSVGElement,
...
SquareSplitHorizontalThin.displayName = 'SquareSplitHorizontalThin';
