...
/**
 * LinkSimpleHorizontalThin icon component
 * Generated from Phosphor Icons
 */
export const LinkSimpleHorizontalThin = React.forwardRef<
  SVGSVGElement,
...
LinkSimpleHorizontalThin.displayName = 'LinkSimpleHorizontalThin';
