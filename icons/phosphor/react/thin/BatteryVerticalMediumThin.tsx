...
/**
 * BatteryVerticalMediumThin icon component
 * Generated from Phosphor Icons
 */
export const BatteryVerticalMediumThin = React.forwardRef<
  SVGSVGElement,
...
BatteryVerticalMediumThin.displayName = 'BatteryVerticalMediumThin';
