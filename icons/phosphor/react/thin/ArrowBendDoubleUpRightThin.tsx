...
/**
 * ArrowBendDoubleUpRightThin icon component
 * Generated from Phosphor Icons
 */
export const ArrowBendDoubleUpRightThin = React.forwardRef<
  SVGSVGElement,
...
ArrowBendDoubleUpRightThin.displayName = 'ArrowBendDoubleUpRightThin';
