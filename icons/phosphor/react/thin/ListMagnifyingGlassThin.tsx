...
/**
 * ListMagnifyingGlassThin icon component
 * Generated from Phosphor Icons
 */
export const ListMagnifyingGlassThin = React.forwardRef<
  SVGSVGElement,
...
ListMagnifyingGlassThin.displayName = 'ListMagnifyingGlassThin';
