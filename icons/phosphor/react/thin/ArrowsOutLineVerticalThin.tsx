...
/**
 * ArrowsOutLineVerticalThin icon component
 * Generated from Phosphor Icons
 */
export const ArrowsOutLineVerticalThin = React.forwardRef<
  SVGSVGElement,
...
ArrowsOutLineVerticalThin.displayName = 'ArrowsOutLineVerticalThin';
