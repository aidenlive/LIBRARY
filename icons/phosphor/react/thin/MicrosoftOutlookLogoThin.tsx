...
/**
 * MicrosoftOutlookLogoThin icon component
 * Generated from Phosphor Icons
 */
export const MicrosoftOutlookLogoThin = React.forwardRef<
  SVGSVGElement,
...
MicrosoftOutlookLogoThin.displayName = 'MicrosoftOutlookLogoThin';
