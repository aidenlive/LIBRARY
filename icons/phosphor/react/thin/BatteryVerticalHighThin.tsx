...
/**
 * BatteryVerticalHighThin icon component
 * Generated from Phosphor Icons
 */
export const BatteryVerticalHighThin = React.forwardRef<
  SVGSVGElement,
...
BatteryVerticalHighThin.displayName = 'BatteryVerticalHighThin';
