...
/**
 * ArrowsCounterClockwiseThin icon component
 * Generated from Phosphor Icons
 */
export const ArrowsCounterClockwiseThin = React.forwardRef<
  SVGSVGElement,
...
ArrowsCounterClockwiseThin.displayName = 'ArrowsCounterClockwiseThin';
