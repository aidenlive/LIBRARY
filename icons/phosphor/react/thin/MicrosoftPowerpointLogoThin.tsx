...
/**
 * MicrosoftPowerpointLogoThin icon component
 * Generated from Phosphor Icons
 */
export const MicrosoftPowerpointLogoThin = React.forwardRef<
  SVGSVGElement,
...
MicrosoftPowerpointLogoThin.displayName = 'MicrosoftPowerpointLogoThin';
