...
/**
 * CaretCircleDoubleUpThin icon component
 * Generated from Phosphor Icons
 */
export const CaretCircleDoubleUpThin = React.forwardRef<
  SVGSVGElement,
...
CaretCircleDoubleUpThin.displayName = 'CaretCircleDoubleUpThin';
