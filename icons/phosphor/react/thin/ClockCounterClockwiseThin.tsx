...
/**
 * ClockCounterClockwiseThin icon component
 * Generated from Phosphor Icons
 */
export const ClockCounterClockwiseThin = React.forwardRef<
  SVGSVGElement,
...
ClockCounterClockwiseThin.displayName = 'ClockCounterClockwiseThin';
