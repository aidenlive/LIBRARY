...
/**
 * SelectionForegroundThin icon component
 * Generated from Phosphor Icons
 */
export const SelectionForegroundThin = React.forwardRef<
  SVGSVGElement,
...
SelectionForegroundThin.displayName = 'SelectionForegroundThin';
