...
/**
 * DotsThreeCircleVerticalThin icon component
 * Generated from Phosphor Icons
 */
export const DotsThreeCircleVerticalThin = React.forwardRef<
  SVGSVGElement,
...
DotsThreeCircleVerticalThin.displayName = 'DotsThreeCircleVerticalThin';
