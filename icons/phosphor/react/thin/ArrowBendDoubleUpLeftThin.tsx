...
/**
 * ArrowBendDoubleUpLeftThin icon component
 * Generated from Phosphor Icons
 */
export const ArrowBendDoubleUpLeftThin = React.forwardRef<
  SVGSVGElement,
...
ArrowBendDoubleUpLeftThin.displayName = 'ArrowBendDoubleUpLeftThin';
