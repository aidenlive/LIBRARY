...
/**
 * PaintBrushHouseholdThin icon component
 * Generated from Phosphor Icons
 */
export const PaintBrushHouseholdThin = React.forwardRef<
  SVGSVGElement,
...
PaintBrushHouseholdThin.displayName = 'PaintBrushHouseholdThin';
