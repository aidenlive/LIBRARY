...
/**
 * CaretCircleDoubleRightThin icon component
 * Generated from Phosphor Icons
 */
export const CaretCircleDoubleRightThin = React.forwardRef<
  SVGSVGElement,
...
CaretCircleDoubleRightThin.displayName = 'CaretCircleDoubleRightThin';
