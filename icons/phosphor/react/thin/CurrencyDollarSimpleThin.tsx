...
/**
 * CurrencyDollarSimpleThin icon component
 * Generated from Phosphor Icons
 */
export const CurrencyDollarSimpleThin = React.forwardRef<
  SVGSVGElement,
...
CurrencyDollarSimpleThin.displayName = 'CurrencyDollarSimpleThin';
