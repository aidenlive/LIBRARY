...
/**
 * ArrowCircleDownLeftThin icon component
 * Generated from Phosphor Icons
 */
export const ArrowCircleDownLeftThin = React.forwardRef<
  SVGSVGElement,
...
ArrowCircleDownLeftThin.displayName = 'ArrowCircleDownLeftThin';
