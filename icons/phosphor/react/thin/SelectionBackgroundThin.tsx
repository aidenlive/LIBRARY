...
/**
 * SelectionBackgroundThin icon component
 * Generated from Phosphor Icons
 */
export const SelectionBackgroundThin = React.forwardRef<
  SVGSVGElement,
...
SelectionBackgroundThin.displayName = 'SelectionBackgroundThin';
