...
/**
 * AlignCenterVerticalThin icon component
 * Generated from Phosphor Icons
 */
export const AlignCenterVerticalThin = React.forwardRef<
  SVGSVGElement,
...
AlignCenterVerticalThin.displayName = 'AlignCenterVerticalThin';
