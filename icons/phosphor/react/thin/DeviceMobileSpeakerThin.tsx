...
/**
 * DeviceMobileSpeakerThin icon component
 * Generated from Phosphor Icons
 */
export const DeviceMobileSpeakerThin = React.forwardRef<
  SVGSVGElement,
...
DeviceMobileSpeakerThin.displayName = 'DeviceMobileSpeakerThin';
