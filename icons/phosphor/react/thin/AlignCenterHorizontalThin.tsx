...
/**
 * AlignCenterHorizontalThin icon component
 * Generated from Phosphor Icons
 */
export const AlignCenterHorizontalThin = React.forwardRef<
  SVGSVGElement,
...
AlignCenterHorizontalThin.displayName = 'AlignCenterHorizontalThin';
