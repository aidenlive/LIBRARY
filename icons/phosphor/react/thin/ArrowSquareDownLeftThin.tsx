...
/**
 * ArrowSquareDownLeftThin icon component
 * Generated from Phosphor Icons
 */
export const ArrowSquareDownLeftThin = React.forwardRef<
  SVGSVGElement,
...
ArrowSquareDownLeftThin.displayName = 'ArrowSquareDownLeftThin';
