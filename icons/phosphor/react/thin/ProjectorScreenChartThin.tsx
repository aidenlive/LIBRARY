...
/**
 * ProjectorScreenChartThin icon component
 * Generated from Phosphor Icons
 */
export const ProjectorScreenChartThin = React.forwardRef<
  SVGSVGElement,
...
ProjectorScreenChartThin.displayName = 'ProjectorScreenChartThin';
