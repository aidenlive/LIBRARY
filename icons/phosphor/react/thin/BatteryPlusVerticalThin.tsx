...
/**
 * BatteryPlusVerticalThin icon component
 * Generated from Phosphor Icons
 */
export const BatteryPlusVerticalThin = React.forwardRef<
  SVGSVGElement,
...
BatteryPlusVerticalThin.displayName = 'BatteryPlusVerticalThin';
