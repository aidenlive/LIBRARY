...
/**
 * ArrowsInLineVerticalThin icon component
 * Generated from Phosphor Icons
 */
export const ArrowsInLineVerticalThin = React.forwardRef<
  SVGSVGElement,
...
ArrowsInLineVerticalThin.displayName = 'ArrowsInLineVerticalThin';
