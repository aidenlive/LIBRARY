...
/**
 * LinkSimpleHorizontalBreakThin icon component
 * Generated from Phosphor Icons
 */
export const LinkSimpleHorizontalBreakThin = React.forwardRef<
  SVGSVGElement,
...
LinkSimpleHorizontalBreakThin.displayName = 'LinkSimpleHorizontalBreakThin';
