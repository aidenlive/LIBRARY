...
/**
 * ArrowCounterClockwiseThin icon component
 * Generated from Phosphor Icons
 */
export const ArrowCounterClockwiseThin = React.forwardRef<
  SVGSVGElement,
...
ArrowCounterClockwiseThin.displayName = 'ArrowCounterClockwiseThin';
